...
public abstract class Action {
    ...
    Action(float startX, float startY, int color, int size, boolean enableEraser) {
        this.startX = startX;
        this.startY = startY;
        this.stopX = startX;
        this.stopY = startY;
        this.color = color;
        this.size = size;
        this.enableEraser = enableEraser;
    }
    ...
    public void setEnableEraser(boolean enableEraser) {
        this.enableEraser = enableEraser;
    }
    ...
    public abstract boolean contains(Path eraserPath, Region clip);
